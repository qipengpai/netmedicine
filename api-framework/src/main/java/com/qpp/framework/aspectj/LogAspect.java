...
import com.qpp.apicommons.enums.BusinessStatus;
import com.qpp.apicommons.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.qpp.apicommons.annotation.Log)")
    ...
    /**
     * @Author qipengpai
     * @Description //TODO 获取请求的参数，放到log中
     * @Date 2018/10/25 13:19
     * @Param [operLog] 操作日志
     * @return void
     * @throws
     **/
